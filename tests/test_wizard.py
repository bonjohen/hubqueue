...
class TestWizard(TestCase):
    ...
    def test_wizard_run(self, mock_success, mock_color, mock_info, mock_header, mock_clear):
        """Test Wizard run."""
    ...
    def test_wizard_run_cancel(self, mock_confirm, mock_warning, mock_color, mock_info, mock_header, mock_clear):
    ...
    @mock.patch('hubqueue.ui.print_color')
    @mock.patch('hubqueue.ui.print_warning')
    def test_wizard_run_keyboard_interrupt(self, mock_warning, mock_color, mock_info, mock_header, mock_clear):
    ...
    def test_repository_wizard(self, mock_multi_select, mock_confirm, mock_select, mock_prompt):
    ...
    @mock.patch('hubqueue.ui.confirm')
    @mock.patch('hubqueue.ui.multi_select')
    def test_issue_wizard(self, mock_multi_select, mock_confirm, mock_select, mock_prompt):
        """Test IssueWizard."""
        # Mock UI functions
    ...
    @mock.patch('hubqueue.ui.select')
    @mock.patch('hubqueue.ui.confirm')
    def test_release_wizard(self, mock_confirm, mock_select, mock_prompt):
        """Test ReleaseWizard."""
        # Mock UI functions
